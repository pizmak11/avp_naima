...
function avp_setup() {
	 ...
	 * If you're building a theme based on avp, use a find and replace
	 * to change 'avp' to the name of your theme in all the template files.
	 */
